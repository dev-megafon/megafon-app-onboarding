...
- **"Добавлять теги к сделке и контакту".** При включении данной настройки, будет добавлять тег «виртуальный номер телефона» при входящем или исходящем для всех создаваемых звонком сущностей в сделку и в контакт. <br />
